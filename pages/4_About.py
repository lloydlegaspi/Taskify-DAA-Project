    ...
    <div class="fade-in-image">
        <div class="description-container"> <!-- Container with white background and shadow -->
            <div class="description">
                ...
                <p>The primary goal of <b>Taskify</b> is to simplify task organization and improve productivity by integrating a user-friendly interface with robust task prioritization capabilities. Unlike conventional digital tools such as basic calendar applications and to-do lists, Taskify incorporates advanced features to accommodate various factors like working hours, break times, and task priorities. This integration helps users avoid inefficiencies, missed deadlines, and the stress of fragmented task management systems.</p>
